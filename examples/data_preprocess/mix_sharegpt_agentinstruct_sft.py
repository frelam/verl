...
def main():
    ...
    print("\nSFT training (Qwen3-0.6B):")
    print("  bash examples/sft/sharegpt_agentinstruct/run_qwen3_0_6b_sft.sh 1 /tmp/qwen3-0.6b-sft")
    print(f"  # or set DATA_DIR={local_save_dir}")
