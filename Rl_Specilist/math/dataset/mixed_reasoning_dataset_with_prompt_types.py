...
from verl.utils.reward_score.math_reward import extract_math_answer, is_valid_ground_truth
...
def extract_math_solution(solution_str: str) -> Optional[str]:
    answer = extract_math_answer(solution_str)
    if answer is not None and not is_valid_ground_truth(answer):
        return None
    return answer
